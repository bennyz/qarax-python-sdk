...
class HostsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.healthcheck_endpoint = _Endpoint(
            settings={
                ...
                'auth': [],
                'endpoint_path': '/hosts/{hostId}/healthcheck',
        ...
        self.install_host_endpoint = _Endpoint(
            settings={
                'response_type': (StringResponse,),
                'auth': [],
    ...
    def healthcheck(
        ...
        **kwargs
        ...
        Runs healthcheck on a host, currently just ensures gRPC connectivity  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.healthcheck(host_id, async_req=True)
        >>> result = thread.get()
    ...
    def install_host(
        ...
        **kwargs
        ...
        kwargs['host_id'] = \
            host_id
        return self.install_host_endpoint.call_with_http_info(**kwargs)
