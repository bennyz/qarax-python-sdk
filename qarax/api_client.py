...
from qarax.exceptions import ApiTypeError, ApiValueError, ApiException
from qarax.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = HostsApi()
        api_instance.add_host  # this is an instance of the class Endpoint
        api_instance.add_host()  # this invokes api_instance.add_host.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_host.callable or self.callable in this class
